                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control form-control-sm" id="iptDescripcionReg" name="iptDescripcionReg"
                        ...
                        <div class="col-12  col-lg-3">
                            <div class="form-group mb-2">
                                ...
                                <input type="number" min="0" class="form-control form-control-sm" step="0.01"
                                    id="iptPrecioCompraReg" placeholder="Precio de Compra" name="iptPrecioCompraReg" required>
                        ...
                        <div class="col-12 col-lg-3">
                            <div class="form-group mb-2">
                                ...
                                <input type="number" min="0" class="form-control form-control-sm" id="iptPrecioVentaReg" name="iptPrecioVentaReg"
                        ...
                        <div class="col-12 col-lg-3">
                            <div class="form-group mb-2">
                                <label class="" for="iptPrecioVentaMayorReg"><i
                                        class="fas fa-dollar-sign fs-6"></i> <span class="small">Precio
                                        Venta x Mayor</span></label>
                                <input type="number" min="0" class="form-control form-control-sm" id="iptPrecioVentaMayorReg" name="iptPrecioVentaMayorReg"
                        ...
                        <div class="col-12 col-lg-3">
                            <div class="form-group mb-2">
                                <label class="" for="iptPrecioVentaOfertaReg"><i
                                        class="fas fa-dollar-sign fs-6"></i> <span class="small">Precio
                                        Venta Oferta</span></label>
                                <input type="number" min="0" class="form-control form-control-sm" id="iptPrecioVentaOfertaReg" name="iptPrecioVentaOfertaReg"
                                    placeholder="Precio de Venta" step="0.01">
                            </div>
                        </div>  
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group mb-2">
                                ...
                                <input type="number" min="0" class="form-control form-control-sm" id="iptStockReg" name="iptStockReg"
